...
The rate arrays presented in Fig.\,\ref{fig:synapses__circuits__responses}(c) and (d) elucidate the response of the circuits. One can see that for a given value of $I^{\mathrm{drive}}$ the rate begins high and gradually decays to zero as a function of $I^{\mathrm{si}}$, with an abrupt cessation at a cutoff value $I^{\mathrm{si}}_{\mathrm{c}}$. The important distinction between the one-junction synapse and the three-junction synapse is that $I^{\mathrm{si}}_{\mathrm{c}}$ is a strong function of 
