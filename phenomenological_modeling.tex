...
\begin{center}
\LARGE{Modeling Loop Neurons as Leaky Integrators}\\ 
\vspace{0.3em}
\large Physics and Hardware for Intelligence Project\\
\vspace{0.0em}
...
%\begin{figure}[h!]
%\centering
%\includegraphics[width=8.6cm]{fig__leaky_integrator.pdf}
...
\captionof{figure}{\label{fig:test}Testing.}
\end{figure}
