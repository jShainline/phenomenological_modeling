...
L_si = 1000e-9;%SI loop inductance
r_si = 10;%SI loop resistance

input_spike_times = [10:50:260 510:50:760]*1e-9;%times at which input synptic spikes occur
...
if strcmp(read_wr_data,'yes')
    ...
    file_name = '_dat__sffg_3jj__linear_regime_pulse_train__si1uH_100ns';
...
I_0_a = 0.428*max(max(I_si_wr));%peaks(1);%
I_si_vec_analytical = f__synaptic_response_function__linear_regime(time_vec,input_spike_times,I_0_a,tau_rise,tau_fall);
