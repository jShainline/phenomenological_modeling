...
To assess the leaky-integrator model, we compare it to SPICE circuit models \cite{wh1991} for various cases.
...
\section{\label{apx:synapses_model}Further details regarding dendrite model}
